...
const Project = () => <DefaultLayout section={'Project'}>
    ...
    <div>
        ...
        {/* <BlockImageLeft image1={'/static/img/scts/components-1.png'} alt1={'Checkbox component states.'}>
            <h2>Understanding the client's world</h2>
            <p>I attended a series of remote workshops with the senior stakeholders and our wider team, to gradually get to know the process for court expenses.</p>
        ...
        {/* <BlockImageRight image1={'/static/img/scts/components-1.png'} alt1={'Checkbox component states.'}>
            <h2>Knowing the users and their needs</h2>
            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
            <p>This is another paragraph.</p>
        </BlockImageRight> */}
        ...
        <BlockContent>
            ...
            <p>I attended and assisted with a series of user testing sessions, totaling around 20. Mostly the participants were made up of people who had prior experience of the Scottish court expenses system.</p>
            <p>We shared the prototype URL with each participant, who attempted to complete the form whilst sharing their screen with us. The participants used a mix of phones and laptops.</p>
        ...
        <BlockSingle figure1modifier={'block-single__figure--desktop'} image={'/static/img/scts/flagged-claim.png'} alt={'A claim detail view of a flagged claim.'}/> 
