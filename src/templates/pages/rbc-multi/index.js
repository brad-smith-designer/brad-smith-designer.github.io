...
export const title = 'RBC Royal Bank of Canada';
        ...
        <div class="project-hero">
            <div class="project-hero__container">
                <div class="project-hero__content">
                    <h1 class="project-hero__heading">RBC Royal Bank of Canada</h1>
                    <div class="project-hero__detail">
                        <div class="project-hero__description">
                            <p>A new multi-product onboarding experience</p>
                        </div>
                    </div>
                </div>
            </div>
