        ...
        <Modal id="js-modal-toggler-1" modalTitle="About" initClass="js-modal modal">
            <div class="modal__content">
                <div class="modal__content-block">
                    <p>I design digital experiences. Currently I'm a Lead Digital Interaction Designer with RBC Royal Bank, in Toronto.</p>
                    <p>My time is spent fully integrated with RBC's design and product team, part of multiple agile squads with different focusses, delivering enhancements and new products features. The work requires me to balance the needs of design team, the product team, and our banking clients whilst also contributing to the RBC design system and libraries.</p>
                    ...
                    <p>For early ideation I use a pen and paper, and conversation. Alongside sketching I use the likes of Figma and Mural to create alignment between parties, produce rapid high-fidelity prototypes to engage stakeholders, test with users, and iterate quickly. </p>
                    <p>In the past I practiced more in-depth prototyping by writing HTML and CSS, and occasionally JS where I could. Writing frontend code for design is controversial but beneficial in my opinion. Whilst this isn't part of today's workflow, having that background allows me to think in terms of reusable components, directly influence the accessibility aspects of a project, make fixes to production code where needed, and speak the same language as frontend and backend developers.</p>
