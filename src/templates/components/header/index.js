        ...
        <Modal id="js-modal-toggler-1" modalTitle="About" initClass="js-modal modal">
            <div class="modal__content">
                <div class="modal__content-block">
                    ...
                    <p>My work always values simplicity, usability and accessibility. I question almost everything, and I don't like to follow trends. I ask questions and try to get to the heart of the problem I'm trying to solve. Most of all I'm open-minded. </p>
